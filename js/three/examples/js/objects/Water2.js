...
THREE.Water = function ( geometry, options ) {
	...
	var normalMap0 = options.normalMap0 || textureLoader.load( 'js/three/examples/textures/water/Water_1_M_Normal.jpg' );
	var normalMap1 = options.normalMap1 || textureLoader.load( 'js/three/examples/textures/water/Water_2_M_Normal.jpg' );
